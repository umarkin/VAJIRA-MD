...
global.owner = process.env.OWNER_NUMBER  || '972529632554' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zYdlGC4C#K4-nPnhgG1rUAGB_ZS1FaId5aDEqyNMarD-UiKuxAd0' ,
